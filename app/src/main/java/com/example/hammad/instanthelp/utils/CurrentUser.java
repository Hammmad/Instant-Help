...
public class CurrentUser {
    ...
    public void setCurrentUser(User user) {
        ...
        editor.putString(Constants.EMAIL, user.emailAddress);
        ...
        editor.putString(Constants.GUARDIAN, user.guardian);
    ...
    public User getCurrentUser() {
        ...
        String guardian = currentUser.getString(Constants.GUARDIAN, null);
        ...
        return new User(uId, fname, lname, email, contact,guardian, country, city, password, gender, volunteer,
				bloodDonor, bloodGroup, firstAider, ambulance, imagePath);
    }
